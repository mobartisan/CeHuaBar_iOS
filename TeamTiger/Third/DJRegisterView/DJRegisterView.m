...
- (void)creatUI:(DJRegisterViewType ) djRegisterViewType
{
    ...
    UIImage *image = [UIImage imageNamed:@"textfield_default_holo_light"];
    image = [image resizableImageWithCapInsets:UIEdgeInsetsMake(0, image.size.width / 2.0, 0, image.size.width / 2.0) resizingMode:UIImageResizingModeStretch];
    ...
    image = [UIImage imageNamed:@"textfield_default_holo_light"];
    image = [image resizableImageWithCapInsets:UIEdgeInsetsMake(0, image.size.width / 2.0, 0, image.size.width / 2.0) resizingMode:UIImageResizingModeStretch];
...
- (void)textFieldDidBeginEditing:(UITextField *)textField
{
    ...
    im.image = [UIImage imageNamed:@"textfield_activated_holo_light"];
}
- (void)textFieldDidEndEditing:(UITextField *)textField
{
    [self setViewY:0 animation:YES];
    UIImageView *im = (UIImageView *)[self viewWithTag:textField.tag+100];
    im.image = [UIImage imageNamed:@"textfield_default_holo_light"];
}
           ...
           djRegisterViewTypeSMS:(DJRegisterViewTypeSMS)djRegisterViewTypeSMS
{
    ...
    if (djRegisterViewTypeSMS == DJRegisterViewTypeNoScanfSMS) {
        ...
        [self addSubview:passImage];
        passImage.image = [UIImage imageNamed:@"textfield_default_holo_light"];
     ...
     // 输入手机号获取验证码界面
        ...
        [self addSubview:accImage];
        accImage.image = [UIImage imageNamed:@"textfield_default_holo_light"];
